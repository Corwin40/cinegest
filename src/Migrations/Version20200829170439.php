 ...
 */
final class Version20200829170439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card ADD CONSTRAINT FK_161498D3F68139D7 FOREIGN KEY (adhesion_id) REFERENCES card (id)');
